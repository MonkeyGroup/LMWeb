...
function MoveDiv(e) {
    ...
    var clientX = event && event.clientX ? event.clientX : 400;
    var clientY = event && event.clientY ? event.clientY : 400;
    _MousePX = _IsIE ? (document.body.scrollLeft + clientX) : (e.pageX ? e.pageX : 400);
    _MousePY = _IsIE ? (document.body.scrollTop + clientY) : (e.pageY ? e.pageY : 400);
